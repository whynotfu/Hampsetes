/**
 * @file databasesingleton.cpp
 * @brief Реализация синглтона базы данных казино
 * @author Команда разработчиков
 * @date 2025
 * @version 1.0
 * 
 * Содержит реализацию классов DatabaseSingleton и DatabaseSingletonDestroyer
 * для управления единственным экземпляром подключения к базе данных SQLite.
 */
